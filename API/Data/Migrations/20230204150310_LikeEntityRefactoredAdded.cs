...
{
    /// <inheritdoc />
    public partial class LikeEntityRefactoredAdded : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserAppUser", x => new { x.LikedByUserId, x.LikedUsersId });
                    table.ForeignKey(
                        name: "FK_AppUserAppUser_Users_LikedByUserId",
